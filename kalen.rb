...
# Listener
  ...
  class POSTListener
    ...
    @@start_messages = ["\#@build@: On your marks, get set, build!",
                        ...
                        "\#@build@: Let's build this thing, yo!",
                        "\#@build@: Tab A into Slot B? Where's Slot B?!",
                        "\#@build@: Prepare the smelteries!",
                        "\#@build@: Starting build. If it's broken, blame Sunstrike.",
                        "\#@build@: Starting build. If it's broken, blame mDiyo.",
                        "\#@build@: Starting build. If it's broken, blame fuj1n.",
                        "\#@build@: Starting build. If it's broken, blame progwml6.",
                        "\#@build@: Starting build. If it's broken, blame Soaryn.",
                        "\#@build@: Starting build. If it's broken, blame Direwolf. Somehow. How does that work anyway?",
                        "\#@build@: For the love of builds, remember the fish!",
                        "\#@build@: Cheer for success, blame Soaryn for failure.",
                        "\#@build@: Starting build. If it's broken, remember, mDiyo loves you",
                        "\#@build@: Build... build... BUILD! MUAHAHAHA!"]
    ...
    @@failure_messages = ["Build \#@build@ thought ice cream was better.",
                          ...
                          "Build \#@build@: Bob the Builder! Can we fix it!? Bob the builder! No we can't!",
                          "Build \#@build@: Hullo, Kalen here, have you tried turning it off and on again?",
                          "Build \#@build@: Halp! It's borked! It's on fire! D:",
                          "Build \#@build@: The Carrot Parrot of Doom was here.",
                          "Build \#@build@: Soaryn broke it, don't look at me.",
                          "Build \#@build@: It wasn't me, I swear!",
                          "Build \#@build@: Moar, moar, MOAR bugs!",
                          "Build \#@build@: Your choice was... poor.",
                          "Build \#@build@: Who stole the semicolon?!",
                          "Build \#@build@: `git blame Soaryn`",
                          "Build \#@build@: `git blame Sunstrike`",
                          "Build \#@build@: `git blame mDiyo`",
                          "Build \#@build@: `git blame fuj1n`",
                          "Build \#@build@: `git blame progwml6`",
                          "Build \#@build@: `git blame Direwolf20`",
                          "Build \#@build@: prog broke the build again! :<",
                          "Build \#@build@: Alright who did it? WHO BROKE THE BUILD NOW!?",
